...
string TesseractOCR::extractText(const char* imagePath, char* dataPath)
{
    string outText;
    ...
    if (api->Init(dataPath, "eng+ara+fra")) {
        return "";
    }
...
int TesseractOCR::detectRotationAngle(Mat image, char* dataPath)
{
    tesseract::TessBaseAPI* api = new tesseract::TessBaseAPI();
